 ...
 * under the License.
 */
package com.clougence.utils.timer;
 ...
 *
 * {@link HashedWheelTimer} is based on <a href="https://cseweb.ucsd.edu/users/varghese/">George Varghese</a> and
 * Tony Lauck's paper, <a href="https://cseweb.ucsd.edu/users/varghese/PAPERS/twheel.ps.Z">'Hashed
 * and Hierarchical Timing Wheels: data structures to efficiently implement a timer facility'</a>.
 * More comprehensive slides are located <a href="https://www.cse.wustl.edu/~cdgill/courses/cs6874/TimingWheels.ppt">here</a>.
 */
public class HashedWheelTimer implements Timer {
    ...
    public HashedWheelTimer(ThreadFactory threadFactory, long tickDuration, TimeUnit unit, int ticksPerWheel, boolean leakDetection, long maxPendingTimeouts){
        ...
        ObjectUtils.checkPositive(tickDuration, "tickDuration");
        ObjectUtils.checkPositive(ticksPerWheel, "ticksPerWheel");
        ...
        if (duration < MILLISECOND_NANOS) {
            logger.warn("Configured tickDuration " + tickDuration + " smaller then " + MILLISECOND_NANOS + ", using 1ms.");
    ...
    private static void reportTooManyInstances() {
        ...
        logger.error("You are creating too many " + resourceType + " instances. " + resourceType + " is a shared resource that must be reused across the JVM, "
        ...
        private void processCancelledTasks() {
            for (;;) {
                ...
                try {
                    ...
                    logger.error("An exception was thrown while process a cancellation task", t);
                }
            }
        }
    ...
    private static final class HashedWheelTimeout implements Timeout {
        ...
        public String toString() {
            ...
            StringBuilder buf = new StringBuilder(192).append(ClassUtils.getShortClassName(this.getClass())).append('(').append("deadline: ");
            if (remaining > 0) {
